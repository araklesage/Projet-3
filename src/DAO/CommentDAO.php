...
class CommentDAO extends DAO 
{
    ...
    public function findAllByArticle($articleId) {
        ...
        $sql = "select com_id, com_author, com_content, parent_id from t_comment where art_id=? order by com_id";
        ...
        $parentComments = array_filter($allComments, function($com) {
            return $com->getParentId() == NULL;
        });

        foreach ($parentComments as $key => $parentComment) {
            $this->setChildComments($allComments, $parentComment);
        }

        return $parentComments;
    }

    function setChildComments($allComments, $comment){

        $childComments = array_filter($allComments, function($com) use ($comment){
            return $com->getParentId() == $comment->getId();
        });
